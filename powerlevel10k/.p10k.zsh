# Generated by Powerlevel10k configuration wizard on 2023-06-27 at 12:40 AEST.
...
# vertical separators, sharp heads, flat tails, 2 lines, solid, left frame, compact,
...
() {
  ...
  # Tip: Remove the next line to always show kubecontext. - Rushyang
  ...
  # Tip: Remove the next line to always show aws. - Rushyang
  #typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awles s|terraform|pulumi|terragrunt'
