# Generated by Powerlevel10k configuration wizard on 2025-03-09 at 00:42 AEDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    yazi                    # Yazi integration with powerlevel10k - Refer changes in shell.yazi plugin's main.lua as well as .zshrc
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 60 )) && branch[23,-23]="…"  # <-- this line
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}󰈅${VCS_STATUS_NUM_UNSTAGED}"
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=234
  ...
  #################[ yazi: yazi shell (custom written - Rushyang) ]##################
  # YAZI_LEVEL - Yazi integration with Powerlevel10k
  function prompt_yazi() {
    local level=${YAZI_LEVEL:-0}
    if (( level > 0 )); then
      p10k segment -t "  $level"
    fi
  }
  # Yazi shell color.
  typeset -g POWERLEVEL9K_YAZI_FOREGROUND=232
  typeset -g POWERLEVEL9K_YAZI_BACKGROUND=40
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=24
  # Custom icon.
