...
" Something related to plugins - by Rushyang -
" https://medium.com/@akila1001/easy-steps-to-install-neovim-in-centos-b90599164379
...
" set showtabline=0
"
" Mess with some CursorLine Config: (Rushyang)
" set CursorLine   cterm=NONE ctermbg=grey ctermfg=white guibg=grey guifg=white
" set CursorColumn cterm=NONE ctermbg=darkred ctermfg=white guibg=darkred guifg=white
" nnoremap <c-Space>c :set hi CursorLine! CursorColumn!<CR>
" nnoremap <c-Space> <c-'> :source $MYVIMRC<CR>
...
let g:ranger_command_override = 'ranger --cmd=tab_close --datadir=/home/vagrant'
...
" I don't know what this is for - commented out by Rushyang
...
" I'm commenting 4 lines out - Rushyang
let g:nord_italic=1
...
" Below is getting commented..
let g:lightline = {
            \ 'colorscheme': 'wombat',
            \ 'active': {
            \   'left': [['statuslinetabs', 'lineinfo'], ['relativepath', 'readonly', 'modified']],
...
" Some key mappings to copy whats selected
vnoremap  <leader>y  "+y
