...
" Somehow c-[ messes with Esc key so pressing Esc also does :tabprevious - So
" disabling it.
...
" Below line was NOT converted to lua and removed.
...
"Just H and L to jump to previous or next change in diff mode
" nnoremap H [c
" nnoremap L ]c
" vnoremap <c-h> ^
" vnoremap <c-l> $
...
""""""""""DONE"""""""""""""Plug 'tpope/vim-fugitive'
""""""""""DONE"""""""""""""" Plug 'tpope/vim-unimpaired'
""""""""""DONE"""""""""""""" Plug 'MobiusHorizons/fugitive-stash.vim'
""""""""""DONE"""""""""""""Plug 'tpope/vim-rhubarb'
""""""""""DONE"""""""""""""Plug 'mhinz/vim-signify'

" Golang support for vim
" Plug 'fatih/vim-go', { 'for': 'go' }

" jedi for python completion
"""""""""""DONE"""""""""""Plug 'davidhalter/jedi-vim', { 'for': ['py', 'python'] }
"""""""""""DONE"""""""""""
"""""""""""DONE"""""""""""" Neovim Coc
"""""""""""DONE"""""""""""Plug 'neoclide/coc.nvim', {'branch': 'release'}
"""""""""""DONE"""""""""""" Plug 'wellle/tmux-complete.vim'
"""""""""""DONE"""""""""""
"""""""""""DONE"""""""""""" Coc extensions
"""""""""""DONE"""""""""""Plug 'neoclide/coc-lists', {'do': 'yarn install --frozen-lockfile'}
"""""""""""DONE"""""""""""" Plug 'neoclide/coc-json', {'do': 'yarn install --frozen-lockfile'}
"""""""""""DONE"""""""""""Plug 'neoclide/coc-yaml', {'do': 'yarn install --frozen-lockfile'}
"""""""""""DONE"""""""""""" Plug 'fannheyward/coc-markdownlint', {'do': 'yarn install --frozen-lockfile'}
"""""""""""DONE"""""""""""" Plug 'neoclide/coc-prettier', {'do': 'yarn install --frozen-lockfile'}
"""""""""""DONE"""""""""""Plug 'neoclide/coc-python', {'do': 'yarn install --frozen-lockfile'}
"""""""""""DONE"""""""""""" Plug 'neoclide/coc-rls', {'do': 'yarn install --frozen-lockfile'}
"""""""""""DONE"""""""""""" Plug 'neoclide/coc-java', {'do': 'yarn install --frozen-lockfile'}

" GoldenSize for split window resize automatically while switching between windows
"""DONE"""""""""Plug 'dm1try/golden_size'

" Alternative file manager
""""""""""DONE""""""""""""Plug 'francoiscabrol/ranger.vim'
" Not using below
...
""""""""""""""""DONE"""""""""""Plug 'junegunn/fzf'
""""""""""""""""DONE"""""""""""Plug 'junegunn/fzf.vim'

" align text
Plug 'junegunn/vim-easy-align'

""""""""""""""DONE""""""""""""Plug 'ntpeters/vim-better-whitespace'
...
luafile $HOME/.config/nvim/LuaInit/init.lua
